...
export const RELEASE_WAVES: readonly WaveDefinition[] = [
  ...
  { number: 5, name: 'Iron Roots', completionBonus: 74, groups: [{ type: EnemyType.IronCaterpillar, count: 8, interval: 6650, delay: 0 }, { type: EnemyType.SwarmWasp, count: 8, interval: 260, delay: 15400 }] },
  ...
  { number: 9, name: 'Pale Endurance', completionBonus: 131, groups: [{ type: EnemyType.PaleMoth, count: 8, interval: 4900, delay: 0 }, { type: EnemyType.BulwarkBeetle, count: 5, interval: 7000, delay: 11200 }, { type: EnemyType.VeilWasp, count: 10, interval: 2940, delay: 22400 }] },
