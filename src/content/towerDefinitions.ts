...
export const TOWER_DEFINITIONS: Record<TowerType, TowerDefinition> = {
  ...
  [TowerType.LumenOracle]: { type: TowerType.LumenOracle, displayName: 'Lumen Oracle', role: TowerRole.Support, description: 'Detects hidden enemies and supports the network', damage: 3, range: 130, fireRate: 650, cost: 220, projectileSpeed: 190, specialEffect: 'detection' },
};
